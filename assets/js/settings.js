jQuery(document).ready(function($) {
    ...
    jQuery( '#borfw_settings .subsubsub a.tab' ).click( function ( e ) {
        ...
        if ( jQuery( this ).hasClass( 'all' ) ) {
            jQuery( '#borfw_settings h3, #borfw_settings form p, #borfw_settings table.form-table, p.submit' ).show();
        ...
        jQuery( '#borfw_settings h2, #borfw_settings form > p:not(".submit"), #borfw_settings table' ).hide();
        jQuery( 'h2#' + toShow ).show().nextUntil( 'h2', 'p, table, table p' ).show();
